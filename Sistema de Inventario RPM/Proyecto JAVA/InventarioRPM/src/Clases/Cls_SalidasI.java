...
public class Cls_SalidasI {
    ...
    public DefaultTableModel getDatosSalida(Date fecha_sql1,Date fecha_sql2 ){
        try {
            setTitulosSalida();
            String SQL_SELECT_SALIDAS = "SELECT sal_id,sal_fecha,sal_pro_codigo,pro_descripcion,sal_cantidad,sal_cantidad1,sal_pro_codigo2,sal_cantidad2 FROM salida INNER JOIN producto ON sal_pro_codigo = pro_codigo where sal_fecha between '"+fecha_sql1+"' and '"+fecha_sql2+"'ORDER BY sal_id ASC";
