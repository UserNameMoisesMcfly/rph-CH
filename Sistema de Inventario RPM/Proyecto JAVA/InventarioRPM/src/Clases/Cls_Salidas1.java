...
public class Cls_Salidas1 {
    ...
    public DefaultTableModel getDatosSalida(String codigo){
        try {
            setTitulosSalida();
            String SQL_SELECT_SALIDAS = "SELECT sal_id,sal_fecha,sal_pro_codigo,pro_descripcion,sal_cantidad,sal_cantidad1,sal_pro_codigo2,sal_cantidad2 FROM salida INNER JOIN producto ON sal_pro_codigo = pro_codigo where pro_codigo='"+codigo+"' ORDER BY sal_id ASC";
