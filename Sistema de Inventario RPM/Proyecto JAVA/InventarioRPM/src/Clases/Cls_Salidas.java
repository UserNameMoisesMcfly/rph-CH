...
public class Cls_Salidas {
    ...
    private final String SQL_SELECT_SALIDAS = "SELECT Concat('0000',sal_id),sal_fecha,sal_pro_codigo,pro_descripcion,sal_cantidad,sal_cantidad1,sal_pro_codigo2,sal_cantidad2 FROM salida INNER JOIN producto ON sal_pro_codigo = pro_codigo ORDER BY sal_id ASC";
    String a="";
    public Cls_Salidas(){
        PS = null;
        CN = new Conectar();
