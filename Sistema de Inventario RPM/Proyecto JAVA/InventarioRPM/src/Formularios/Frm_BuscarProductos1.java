...
public class Frm_BuscarProductos1 extends javax.swing.JInternalFrame {
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        if(Frm_Entrada.enviar == 1){
            ...
            Frm_Entrada.txt_codigo1.setText(tabla.getValueAt(row, 0).toString());
           // Frm_Entrada.txt_descripcion.setText(tabla.getValueAt(row, 1).toString());
            Frm_Entrada.txt_cantidad2.requestFocus();
           //Frm_Entrada.txt_cantidad1.requestFocus();
            Frm_Entrada.enviar = 0;
            dispose();
        }   
        else if(Frm_Merma.enviar == 1){
            int row = tabla.getSelectedRow();
            Frm_Merma.txt_codigo.setText(tabla.getValueAt(row, 0).toString());
            Frm_Merma.txt_descripcion.setText(tabla.getValueAt(row, 1).toString());
            Frm_Merma.txt_cantidad.requestFocus();
            Frm_Merma.enviar = 0;
            dispose();
        }
        else if(Frm_Salida.enviar == 1){
            int row = tabla.getSelectedRow();
            Frm_Salida.txt_codigo1.setText(tabla.getValueAt(row, 0).toString());
            Frm_Salida.txt_descripcion1.setText(tabla.getValueAt(row, 1).toString());
            Frm_Salida.txt_cantidad1.requestFocus();
            Frm_Salida.enviar = 0;
            dispose();
        }
