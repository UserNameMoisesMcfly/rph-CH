...
public class Frm_Login1 extends javax.swing.JFrame {
    ...
    private void login(){
        String usuario = "RPM";
        String clave = "rpm.chihuahua2023";
        String usuario1 = "Eleazar Zarate";
        String clave1 = "eleazar.rpm2023";
        String usuario2 = "Luis Tzoyohua";
        String clave2 = "luis.rpm.chihuahua";
         String usuario3 = "Usuario 3";
        String clave3 = "u3.rpm";
        ...
        else if(usuario1.equals(user) && clave1.equals(pass)){
            Frm_Principal ing = new Frm_Principal();
            ing.setVisible(true);
            ing.show();
            dispose();
        }else if(usuario2.equals(user) && clave2.equals(pass)){
            Frm_Principal ing = new Frm_Principal();
            ing.setVisible(true);
            ing.show();
            dispose();
        }else if(usuario3.equals(user) && clave3.equals(pass)){
            Frm_Principal ing = new Frm_Principal();
            ing.setVisible(true);
            ing.show();
            dispose();
